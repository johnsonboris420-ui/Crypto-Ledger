 ...
 */
export const getGetTokenTransfersUrl = () => {
  return `/api/token-transfers`;
};

export const getTokenTransfers = async (
  options?: RequestInit,
): Promise<TokenTransfer[]> => {
  return customFetch<TokenTransfer[]>(getGetTokenTransfersUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetTokenTransfersQueryKey = () => {
  return [`/api/token-transfers`] as const;
};

export const getGetTokenTransfersQueryOptions = <
  TData = Awaited<ReturnType<typeof getTokenTransfers>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getTokenTransfers>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetTokenTransfersQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getTokenTransfers>>
  > = ({ signal }) => getTokenTransfers({ signal, ...requestOptions });
...
export type GetTokenTransfersQueryResult = NonNullable<
  Awaited<ReturnType<typeof getTokenTransfers>>
>;
export type GetTokenTransfersQueryError = ErrorType<unknown>;

/**
 * @summary Get token transfer history
 */

export function useGetTokenTransfers<
  TData = Awaited<ReturnType<typeof getTokenTransfers>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryOptions = getGetTokenTransfersQueryOptions(options);
